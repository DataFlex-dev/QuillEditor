...
Deferred_View Activate_oFeedbackCreateSecure for ;
Object oFeedbackCreateSecure is a dbView
    ...
    Set Size to 324 563
    Set Location to -2 1
    Set Label to "FeedbackCreateSecure"
